...
////////////////////////////////////////////////////////////////
  ...
  {                                      
    if (args.length == 0)
      System.out.println("usage: XInputStreamReader <file|dir>");
    else
    ...
    throws Exception
  {
    ...
    XInputStreamReader r = new XInputStreamReader(new FileInputStream(f));
    int line = 1;
    try
    {
      int c;       
    ...
    { 
      System.out.println("FAILED: " + f + " [Line " + line + "]");
    }
  }      
